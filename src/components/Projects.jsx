...
import { ExternalLink, Github, Star, AlertTriangle, ArrowUp } from "lucide-react";
...
const ProjectCard = React.memo(function ProjectCard({ project, index, renderTech }) {
  return (
    <motion.div
      {...fadeInUp}
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          ...
          loading="lazy"
          decoding="async"
          fetchPriority={index < 2 ? "high" : "low"} // Optimized Image Loading
        ...
        {project.unCompleted && (
          <div className="absolute top-4 left-4 px-3 py-1 bg-orange-500 text-white text-xs font-semibold rounded-full flex items-center gap-1">
        ...
        {project.upgradable && (
          <div className="absolute top-16 right-4 px-3 py-1 bg-green-500 text-white text-xs font-semibold rounded-full flex items-center gap-1">
            <ArrowUp size={12} />
            Upgradable
          </div>
        )}
